...
(function(X){X.ResourcesPath='https://tst.dynamsoft.com/libs/dwt/13.4.1';X.AutoLoad=true;X.Containers=[{ContainerId:"dwtcontrolContainer",Width:270,Height:350}];X.Trial=true;X.ActiveXInstallWithCAB=false;X.IfUpdateService=false;
X.ProductKey='t010755QEAAIODtqPVfF2vUIwabNaLRG/Y4twI75RLXBNjylk2asWQjIi+D7werlponky1ViNB/U91+fYlAMOFMnis4ByQiY0YCRi3qw0jX13T2ItpmCbzXebeuUxH/0YCxv4NO//AkKFVD9/RXlE=';function W(V){if(V||X.inited){if(Dynamsoft.Lib.html5.Funs.checkProductKey(X.GetWebTwain(X.Containers[0].ContainerId),{'Core':true})){clearInterval(Y);return true;}
else {if (Dynamsoft && Dynamsoft.Lib.product.bChromeEdition){dynamsoft.lib.dialog.dm._blockDocument();var Z = [];Z.push('<div style="padding:30px;">');Z.push("You are seeing errors because the ProductKey is not valid or has expired. <br /> Please <br />");Z.push(" 1. <a href='https://www.dynamsoft.com/CustomerPortal/Portal/TrialLicense.aspx' target='_blank'>Request a <strong>Dynamic Web TWAIN</strong> trial license</a><br />");
Z.push(" 2. Refer to this <strong><a href='https://developer.dynamsoft.com/?page_id=18633'>article</a></strong> to update the ProductKey<br />");Z.push(" 3. Do a <strong>hard refresh</strong> or clear cache in your browser to make sure the new ProductKey is used<br />");Z.push(" 4. If the issue persists, please contact <a href='mailto:support@dynamsoft.com'>support@dynamsoft.com</a>");
Z.push('</div>');Dynamsoft.WebTwainEnv.ShowDialog(530, 230, Z.join(''));if(document.getElementsByClassName("dynamsoft-dwt-dlg-header"))document.getElementsByClassName("dynamsoft-dwt-dlg-header")[0].style.display = "none";}clearInterval(Y);return false;}}else return false;}var Y=setInterval(W, 1000);})(Dynamsoft.WebTwainEnv);
